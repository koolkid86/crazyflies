...
prevRZ1 = 0.7
pointnum = 0
random.seed(62352442454545411244545444544421)
...
def inputs():
    ...
    #RX1 = prevX1 + ((random.randint(-100,100) / 100) * 0.5)
    #RY1 = prevY1 + ((random.randint(-100,100) / 100) * 0.5)
    #RZ1 = prevZ1 + ((random.randint(-100,100) / 100) * 0.5)
    ...
    #Drone Flight Command Info
        ...
        (3, 0, Wait(2)),
        (3, 1, Wait(2)),
        (2, 0, Goto(prevRX1, prevRY1, 0.7, S1)),
        (2, 1, Goto(prevprevRX1, prevprevRY1, 0.3, S2)),
        (3, 0, Wait(2)),
        (3, 1, Wait(2)),
        (4, 0, Goto(RX1, RY1, 0.7, S1)),
        (4, 1, Goto(prevRX1, prevRY1, 0.3, S2)),
        (5, 0, Wait(2)),
        (5, 1, Wait(2)),
        (6, 0, Goto(RX1, RY1, RZ1, S1)),
        (6, 1, Goto(prevRX1, prevRY1, prevRZ1, S2)),
    ]
